if File.exists?(File.expand_path("#{RAILS_ROOT}/config/locale_settings.yml"))
  locale_settings = YAML::load(File.open(File.expand_path("#{RAILS_ROOT}/config/locale_settings.yml")))
